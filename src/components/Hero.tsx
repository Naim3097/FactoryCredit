                ...
                <div className="space-y-3">
                  ...
                  {waUrl && (
                    <a
                      ...
                      className="inline-flex items-center justify-center gap-2 w-full bg-[#25D366] hover:bg-[#1ebe57] text-white font-semibold py-3 px-4 rounded-lg transition-colors"
                    >
