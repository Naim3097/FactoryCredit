    ...
    },
    {
      ...
      fields: [
        ...
        { name: "mapUrl", type: "text", required: true },
        {
          ...
          type: "text",
          required: false,
          admin: { description: "Optional Facebook page URL for this branch." },
        },
        {
          name: "instagramUrl",
          type: "text",
          required: false,
          admin: { description: "Optional Instagram profile URL for this branch." },
        },
        {
          name: "tiktokUrl",
          type: "text",
          required: false,
          admin: { description: "Optional TikTok profile URL for this branch." },
        },
      ],
    },
